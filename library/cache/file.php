<?php
// $Id: file.php 2684 2010-07-18 17:30:05Z dualface $
 ...
 * @version $Id: file.php 2684 2010-07-18 17:30:05Z dualface $
 * @package cache
 */
...
class QCache_File
{
	...
	function get($id, array $policy = null)
	{
		...
		$len = filesize($path);
		if (!PHP53) $mqr = get_magic_quotes_runtime();
		...
		do
        {
			...
			if (!PHP53) set_magic_quotes_runtime($mqr);
		} while (false);
